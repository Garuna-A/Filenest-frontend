...
export default function Upload() {
  ...
  useEffect(() => {
    const fetchFolders = async () => {
      const res = await fetch("https://filenest-production-9bb3.up.railway.app/folder-list", {
        credentials: "include",
  ...
  const handleCreateFolder = async (e) => {
    ...
    const res = await fetch("https://filenest-production-9bb3.up.railway.app/folder", {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("https://filenest-production-9bb3.up.railway.app/upload", {
      method: "POST",
      body: formData,
      credentials: "include",
    });
